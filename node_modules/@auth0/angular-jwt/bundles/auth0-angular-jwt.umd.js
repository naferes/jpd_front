(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs/operators'), require('url'), require('rxjs'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('@auth0/angular-jwt', ['@angular/core','exports', '@angular/core', 'rxjs/operators', 'url', 'rxjs', '@angular/common/http'], factory) :
    (global = global || self, factory(global.ng.core,(global.auth0 = global.auth0 || {}, global.auth0['angular-jwt'] = {}), global.ng.core, global.rxjs.operators, global.url, global.rxjs, global.ng.common.http));
}(this, (function (ɵngcc0,exports, core, operators, url, rxjs, http) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var JwtHelperService = /** @class */ (function () {
        ...
        JwtHelperService = __decorate([ __param(0, core.Inject(JWT_OPTIONS)),
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(JwtHelperService, [{
    ...
    var JwtInterceptor = /** @class */ (function () {
        ...
        JwtInterceptor.prototype.isBlacklistedRoute = function (request) {
            var requestedUrl = url.parse(request.url, false, true);
            return (this.blacklistedRoutes.findIndex(function (route) {
                if (typeof route === "string") {
                    var parsedRoute = url.parse(route, false, true);
        ...
        JwtInterceptor = __decorate([ __param(0, core.Inject(JWT_OPTIONS)),
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(JwtInterceptor, [{
    ...
    var JwtModule = /** @class */ (function () {
        ...
        JwtModule = JwtModule_1 = __decorate([ __param(0, core.Optional()), __param(0, core.SkipSelf()),
